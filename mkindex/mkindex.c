...
//	chdir("/tmp");
	...
	FILE *fp4 = fopen("lammot360.tsv", "w+");
	FILE *fp5 = fopen("lammot720.tsv", "w+");
	FILE *fp6 = fopen("lammot1440.tsv", "w+");
 ...
 //printf("Locale is %s",setlocale(LC_ALL, "en_US.UTF-8"));
	...
	res = PQexec(conn, "select hhmm, ulko, meno, paluu from viim360c order by ts desc");
         
	if (PQresultStatus(res) != PGRES_TUPLES_OK) {
		puts("We did not get any data from viim360!");
		exit(0);
}
	rec_count = PQntuples(res);        
	...
	avg360 = PQexec(conn, "select * from avg360, continuous(360), slope(360)");
	avg720 = PQexec(conn, "select * from avg720, continuous(720), slope(720)");
	avg1440 = PQexec(conn, "select * from avg1440, continuous(1440), slope(1440)");
	...
	for ( r=0; r < 5; r++) {
		...
		average360[r] = PQgetvalue(avg360, 0, r);
...
//    gnuplot_cmd(h1, "plot \"lammot30.tsv\" u 1:2 w l t \"Ulkoilma\", \"lammot30.tsv\" u 1:3 w l t \"Menoilma\", \"lammot30.tsv\" u 1:4 w l t \"Poistoilma\" ");
    gnuplot_cmd(h1, "plot \"lammot30.tsv\" u 1:2 w l t \"Ulkoilma\" lt rgb \"green\", \"lammot30.tsv\" u 1:3 w l t \"Menoilma\" lt rgb \"red\", \"lammot30.tsv\" u 1:4 w l t \"Poistoilma\" lt rgb \"blue\" ");
    gnuplot_close(h1) ;
...
//  gnuplot_cmd(h2, "plot \"lammot60.tsv\" u 1:2 w l t \"Ulkoilma\", \"lammot60.tsv\" u 1:3 w l t \"Menoilma\", \"lammot60.tsv\" u 1:4 w l t \"Poistoilma\" ");
    gnuplot_cmd(h2, "plot \"lammot60.tsv\" u 1:2 w l t \"Ulkoilma\" lt rgb \"green\", \"lammot60.tsv\" u 1:3 w l t \"Menoilma\" lt rgb \"red\", \"lammot60.tsv\" u 1:4 w l t \"Poistoilma\" lt rgb \"blue\" ");
    gnuplot_close(h2) ;
    ...
    gnuplot_cmd(h3, "set output \"viim360.png\"") ;
    ...
    gnuplot_cmd(h3, "plot \"lammot360.tsv\" u 1:2 w l t \"Ulkoilma\" lt rgb \"green\", \"lammot360.tsv\" u 1:3 w l t \"Menoilma\" lt rgb \"red\", \"lammot360.tsv\" u 1:4 w l t \"Poistoilma\" lt rgb \"blue\" ");
    gnuplot_close(h3) ;

    gnuplot_ctrl * h4 ;
    h4 = gnuplot_init() ;
    gnuplot_set_xlabel(h4, "Viimeiset kaksitoista tuntia") ;  
    gnuplot_cmd(h4, "set terminal png size 800,480") ;
    gnuplot_cmd(h4, "set output \"viim720.png\"") ;
    ...
    //gnuplot_cmd(h3, "plot \"lammot720.tsv\" u 1:2 w l t \"Ulkoilma\", \"lammot720.tsv\" u 1:3 w l t \"Menoilma\", \"lammot720.tsv\" u 1:4 w l t \"Poistoilma\" ");
    gnuplot_cmd(h4, "plot \"lammot720.tsv\" u 1:2 w l t \"Ulkoilma\" lt rgb \"green\", \"lammot720.tsv\" u 1:3 w l t \"Menoilma\" lt rgb \"red\", \"lammot720.tsv\" u 1:4 w l t \"Poistoilma\" lt rgb \"blue\" ");
    gnuplot_close(h4) ;
    ...
    gnuplot_ctrl * h5 ;
    h5 = gnuplot_init() ;
    gnuplot_set_xlabel(h5, "Viimeiset 24 tuntia") ;
    gnuplot_cmd(h5, "set terminal png size 800,480") ;
    gnuplot_cmd(h5, "set output \"viim1440.png\"") ;
    gnuplot_cmd(h5, "set key left top") ;
    gnuplot_cmd(h5, "set xdata time") ;
    gnuplot_cmd(h5, "set timefmt \"%%Y-%%m-%%dT%%H:%%M\"") ;
    gnuplot_cmd(h5, "set format x \"%H:%M\"") ;
    ...
    gnuplot_cmd(h5, "plot \"lammot1440.tsv\" u 1:2 w l t \"Ulkoilma\" lt rgb \"green\", \"lammot1440.tsv\" u 1:3 w l t \"Menoilma\" lt rgb \"red\", \"lammot1440.tsv\" u 1:4 w l t \"Poistoilma\" lt rgb \"blue\" ");
    gnuplot_close(h5) ;
	...
	fprintf(idx, "</TD></TR>");
	fprintf(idx, "<TR><TD>");
	fprintf(idx, "<img src=\"viim360.png\" alt=\"Viimeiset kuusi tuntia\">\n");
	// fprintf(idx, "</TD><TD>");
	fprintf(idx, "</TD></TR>");
	fprintf(idx, "<TR><TD>");
	fprintf(idx, "<img src=\"viim720.png\" alt=\"Viimeiset kaksitoista tuntia\">\n");
	// fprintf(idx, "</TD><TD>");
	fprintf(idx, "</TD></TR>");
	fprintf(idx, "<TR><TD>");
	...
	fprintf(idx, "</TR><TR>");
	fprintf(idx, "<TD>360 min</TD>");
	for( j = 0; j < 5 ; j++) {
		fprintf(idx, "<TD>%s</TD> " ,average360[j]);
	}
...
int upload2ftp(void) {
	...
	const char *input4 = "viim360.png";
	const char *input5 = "viim720.png";
	const char *input6 = "viim1440.png";
